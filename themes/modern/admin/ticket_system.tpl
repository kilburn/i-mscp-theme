    ...
    <body>
        ...
        <div class="location">
            <div class="location-area icons-left">
                <h1 class="general">{TR_MENU_SUPPORT_SYSTEM}</h1>
            </div>
            ...
            <ul class="path">
                <li><a href="index.php">{TR_OPEN_TICKETS}</a></li>
            </ul>
        </div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <script type="text/javascript">
                            <!--
                            document.write('<a class="icon i_edit" href="ticket_view.php?ticket_id={ID}&screenwidth='+screen.width+'" class="link">{SUBJECT}</a>');
                            //-->
                        </script>
