<!--- Kilburn actiza bien pero en el correo y disco solo me deja poner ilimitados -->
...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en">
    ...
    <body>
        ...
        <div class="body">
            ...
            <h2 class="general"><span>{TR_EDIT_DOMAIN}</span></h2>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>{TR_DOMAIN_NEW_EXPIRE} <img src="{THEME_COLOR_PATH}/images/icons/help.png" width="16" height="16" onmouseover="showTip('dmn_exp_help', event)" onmouseout="hideTip('dmn_exp_help')" /></td>
                ...
                <td width="25"></td>
                <tr>
                    <td><input name="Submit" type="submit" class="button" value="{TR_UPDATE_DATA}" /></td>

                    <td><input name="Submit" type="submit" class="button" onclick="MM_goToURL('parent','users.php');return document.MM_returnValue" value=" {TR_CANCEL} " /></td>
                </tr>
                <tr>
                    <td><input type="hidden" name="uaction" value="sub_data" /></td>
                </tr>
            </table></form>
        </div>
        <div class="footer">
