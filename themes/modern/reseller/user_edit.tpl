        ...
        <div class="body">
            ...
            <form name="search_user" method="post" action="user_edit.php">
                <table>
                    <tr>
                        <td>{TR_USERNAME}</td>
                        <td width="343">{VL_USERNAME}</td>
                    </tr>
                    <tr>
                        <td><label for="userpassword">{TR_PASSWORD}</label></td>
                        <td><input type="password" name="userpassword" id="userpassword" value="{VAL_PASSWORD}"/>
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="send_data" checked="checked" />
                            {TR_SEND_DATA}</td>
                    </tr>
                </table>
